...
public class ModuleManager {
    ...
    private void addModules() {
        Sentry.withScope(scope -> {
            scope.setTransaction("addModules");
            mods.add(new Flight());
    ...
    public void disableMod(String name) {
        Sentry.withScope(scope -> {
            scope.setTag("mod", name);
            scope.setTag("enabled", "false");
            scope.setTransaction("disableMod");
    ...
    public void enableMod(String name) {
        Sentry.withScope(scope -> {
            scope.setTag("mod", name);
            scope.setTag("enabled", "true");
            scope.setTransaction("enableMod");
